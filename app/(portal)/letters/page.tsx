  ...
  return (
    <main style={{ backgroundColor: "#0A0A0E", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", margin: "0", padding: "0" }}>
      <div style={{ maxWidth: "600px", width: "100%", backgroundColor: "#0A0A0E", border: "1px solid rgba(255,255,255,0.05)", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ padding: "24px clamp(16px, 6vw, 40px) 32px", display: "flex", flexDirection: "column", alignItems: "center", gap: "12px" }}>
          <Image src={`${BASE}/Gateway-to-Web-3.0.png`} width={397} height={39} alt="Gateway to Web 3.0" style={{ display: "block", marginBottom: "8px", maxWidth: "100%", height: "auto" }} />
          ...
          {LETTERS.map((letter) => (
            <Link
              ...
              style={{ display: "flex", alignItems: "center", gap: "16px", border: "1px solid rgba(255,255,255,0.1)", padding: "16px", textDecoration: "none", color: "#ffffff", width: "100%", boxSizing: "border-box", flexWrap: "wrap" }}
            >
        ...
        <ScaleToFit naturalWidth={600} naturalHeight={190}>
          <div style={{ position: "relative", width: "600px", height: "190px", overflow: "hidden" }}>
            ...
            <Image src={`${BASE}/vector.svg`} width={600} height={148} alt="" style={{ position: "absolute", top: "40px", left: "0px", width: "600px", height: "148px" }} />
            <Image src={`${BASE}/group.svg`} width={600} height={148} alt="" style={{ position: "absolute", top: "40px", left: "0px", width: "600px", height: "148px" }} />
